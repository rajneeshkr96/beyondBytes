        ...
        <header className=''>
            <div className='min-h-[70vh] grid grid-cols-3 grid-rows-[repeat(2,auto)] '>
                <div className='col-start-1 col-end-4'>
                    <h1 className={`font-medium ${font} text-7xl capitalize line-clamp-2`}>{title}</h1>
                    <p className='text-gray-600 capitalize px-6 line-clamp-1'>{title}</p>
                </div>
                <div className='col-start-1 col-end-2 px-6 py-2 flex  gap-x-2'>
                ...
                <div className='col-start-2 col-end- flex justify-between px-6 py-2'>
                    <div >
